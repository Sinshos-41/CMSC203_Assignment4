 ...
 * Description: This class provides a graphical user interface for creating and managing a 
 * property management company. It allows users to input details for the management 
 * company and properties, and interact with the system through buttons to add properties, 
 * calculate total rent, find the highest rent property, and view a list of managed properties.
 * It also includes visual feedback for the layout of property plots.
 * Due: 04/22/25
