 ...
 * Description: This class represents the property management company. It holds the company’s name, tax ID, management fee, 
 * and an array of up to 5 properties. It manages adding properties, making sure they don't overlap and fit within the company’s 
 * plot, calculates total rent, finds the property with the highest rent, and checks if the array is full.
 * Due: 04/22/25
